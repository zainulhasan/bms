...
namespace bms {
    ...
    public partial class dbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(string name, string username, string password, string age, string address, string phone, string email) {
...
namespace bms.dbDataSet1TableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[user] WHERE (([id] = @Original_id) AND ([name] = @Original_nam" +
                ...
                "ND ([age] = @Original_age) AND ([phone] = @Original_phone) AND ([email] = @Origi" +
                "nal_email))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[user] ([name], [username], [password], [age], [address], [phone], [email]) VALUES (@name, @username, @password, @age, @address, @phone, @email);
SELECT id, name, username, password, age, address, phone, email FROM [user] WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [name] = @name, [username] = @username, [password] = @password, [age] = @age, [address] = @address, [phone] = @phone, [email] = @email WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([age] = @Original_age) AND ([phone] = @Original_phone) AND ([email] = @Original_email));
SELECT id, name, username, password, age, address, phone, email FROM [user] WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, username, password, age, address, phone, email FROM dbo.[user]";
        ...
        public virtual int Fill(dbDataSet1.userDataTable dataTable) {
        ...
        public virtual dbDataSet1.userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbDataSet1.userDataTable dataTable = new dbDataSet1.userDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbDataSet1.userDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_username, string Original_password, string Original_age, string Original_phone, string Original_email) {
        ...
        public virtual int Insert(string name, string username, string password, string age, string address, string phone, string email) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string username, string password, string age, string address, string phone, string email, int Original_id, string Original_name, string Original_username, string Original_password, string Original_age, string Original_phone, string Original_email, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string username, string password, string age, string address, string phone, string email, int Original_id, string Original_name, string Original_username, string Original_password, string Original_age, string Original_phone, string Original_email) {
            return this.Update(name, username, password, age, address, phone, email, Original_id, Original_name, Original_username, Original_password, Original_age, Original_phone, Original_email, Original_id);
        }
    }
