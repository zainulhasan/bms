...
namespace bms {
    ...
    public partial class dbDataSet3 : global::System.Data.DataSet {
        ...
        public partial class donorDataTable : global::System.Data.TypedTableBase<donorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public donorRow AdddonorRow(int id, string name, string address, string city, string phone, string email, int age, string bloodGroup) {
...
namespace bms.dbDataSet3TableAdapters {
    ...
    public partial class donorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[donor] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_bloodGroup = 1 AND [bloodGroup] IS NULL) OR ([bloodGroup] = @Original_bloodGroup)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[donor] ([id], [name], [address], [city], [phone], [email], [age], [bloodGroup]) VALUES (@id, @name, @address, @city, @phone, @email, @age, @bloodGroup);
SELECT id, name, address, city, phone, email, age, bloodGroup FROM donor WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[donor] SET [id] = @id, [name] = @name, [address] = @address, [city] = @city, [phone] = @phone, [email] = @email, [age] = @age, [bloodGroup] = @bloodGroup WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)) AND ((@IsNull_bloodGroup = 1 AND [bloodGroup] IS NULL) OR ([bloodGroup] = @Original_bloodGroup)));
SELECT id, name, address, city, phone, email, age, bloodGroup FROM donor WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, city, phone, email, age, bloodGroup FROM dbo.donor";
        ...
        public virtual int Fill(dbDataSet3.donorDataTable dataTable) {
        ...
        public virtual dbDataSet3.donorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbDataSet3.donorDataTable dataTable = new dbDataSet3.donorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbDataSet3.donorDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_city, string Original_phone, string Original_email, global::System.Nullable<int> Original_age, string Original_bloodGroup) {
        ...
        public virtual int Insert(int id, string name, string address, string city, string phone, string email, global::System.Nullable<int> age, string bloodGroup) {
        ...
        public virtual int Update(int id, string name, string address, string city, string phone, string email, global::System.Nullable<int> age, string bloodGroup, int Original_id, string Original_name, string Original_city, string Original_phone, string Original_email, global::System.Nullable<int> Original_age, string Original_bloodGroup) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string city, string phone, string email, global::System.Nullable<int> age, string bloodGroup, int Original_id, string Original_name, string Original_city, string Original_phone, string Original_email, global::System.Nullable<int> Original_age, string Original_bloodGroup) {
            return this.Update(Original_id, name, address, city, phone, email, age, bloodGroup, Original_id, Original_name, Original_city, Original_phone, Original_email, Original_age, Original_bloodGroup);
        }
    }
