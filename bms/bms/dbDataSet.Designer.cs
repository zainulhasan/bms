...
namespace bms {
    ...
    public partial class dbDataSet : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(string name, string username, string password, string age, string address) {
...
namespace bms.dbDataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[user] ([name], [username], [password], [age], [address]) VALUE" +
                "S (@name, @username, @password, @age, @address);\r\nSELECT id, name, username, pas" +
                "sword, age, address FROM [user] WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [name] = @name, [username] = @username, [password] = @password, [age] = @age, [address] = @address WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([age] = @Original_age));
SELECT id, name, username, password, age, address FROM [user] WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, username, password, age, address FROM dbo.[user]";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_username, string Original_password, string Original_age) {
        ...
        public virtual int Insert(string name, string username, string password, string age, string address) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string username, string password, string age, string address, int Original_id, string Original_name, string Original_username, string Original_password, string Original_age, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string username, string password, string age, string address, int Original_id, string Original_name, string Original_username, string Original_password, string Original_age) {
            return this.Update(name, username, password, age, address, Original_id, Original_name, Original_username, Original_password, Original_age, Original_id);
        }
    }
