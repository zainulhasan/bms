...
namespace bms {
    ...
    public partial class dbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class donorDataTable : global::System.Data.TypedTableBase<donorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public donorRow AdddonorRow(int id, string name, string address, string city, string phone, string email, int age, string bloodGroup, string dob) {
        ...
        public partial class donorRow : global::System.Data.DataRow {
            ...
            public string dob {
                get {
                    return ((string)(this[this.tabledonor.dobColumn]));
                }
                set {
                    this[this.tabledonor.dobColumn] = value;
                }
            }
        }
...
namespace bms.dbDataSet2TableAdapters {
    ...
    public partial class donorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[donor] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([city] = @Original_city) AND ([phone] = @Original_phone) AND ([email] = @Original_email) AND ([age] = @Original_age) AND ([bloodGroup] = @Original_bloodGroup) AND ([dob] = @Original_dob))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[donor] ([id], [name], [address], [city], [phone], [email], [age], [bloodGroup], [dob]) VALUES (@id, @name, @address, @city, @phone, @email, @age, @bloodGroup, @dob);
SELECT id, name, address, city, phone, email, age, bloodGroup, dob FROM donor WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[donor] SET [id] = @id, [name] = @name, [address] = @address, [city] = @city, [phone] = @phone, [email] = @email, [age] = @age, [bloodGroup] = @bloodGroup, [dob] = @dob WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([city] = @Original_city) AND ([phone] = @Original_phone) AND ([email] = @Original_email) AND ([age] = @Original_age) AND ([bloodGroup] = @Original_bloodGroup) AND ([dob] = @Original_dob));
SELECT id, name, address, city, phone, email, age, bloodGroup, dob FROM donor WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, city, phone, email, age, bloodGroup, dob FROM dbo.donor" +
                "";
        ...
        public virtual int Fill(dbDataSet2.donorDataTable dataTable) {
        ...
        public virtual dbDataSet2.donorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbDataSet2.donorDataTable dataTable = new dbDataSet2.donorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbDataSet2.donorDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_city, string Original_phone, string Original_email, int Original_age, string Original_bloodGroup, string Original_dob) {
        ...
        public virtual int Insert(int id, string name, string address, string city, string phone, string email, int age, string bloodGroup, string dob) {
        ...
        public virtual int Update(
                    ...
                    string Original_bloodGroup, 
                    string Original_dob) {
            return this.Update(Original_id, name, address, city, phone, email, age, bloodGroup, dob, Original_id, Original_name, Original_city, Original_phone, Original_email, Original_age, Original_bloodGroup, Original_dob);
        }
    }
